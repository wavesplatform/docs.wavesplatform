...
| Блок | [Высота блокчейна](/ru/blockchain/glossary#высота-бnoкчейна), на которой [транзакция выпуска](/ru/blockchain/transaction-type/issue-transaction) попала в [блок](/ru/blockchain/block/) |
