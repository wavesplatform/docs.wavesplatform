...
Файл конфигурации должен содержать уникальные характеристики вашей ноды (IP-адрес, имя, ключи и т. д.), а также [тип и параметры блокчейна](#настройки-блокчейна).
