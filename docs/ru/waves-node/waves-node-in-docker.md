...
Самый простой способ запустить ноду Waves - это развернуть **Waves Docker container**. Таким способом можно запустить ноду или поменять её настройки всего одной командой.

## Предварительные требования

Необходимо установить Docker последней версии.

Установка подробно описана на [сайте](https://docs.docker.com/engine/installation/) Docker.
...
* Контейнер скачивает файл `.jar` вместе с файлами конфигурации из секции [releases](https://github.com/wavesplatform/Waves/releases) и осуществляет запуск.
