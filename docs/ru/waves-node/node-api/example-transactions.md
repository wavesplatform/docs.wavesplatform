...
Ниже представлен список реальных транзакций каждого типа в сетях **testnet** и **mainnet**.

## V1 транзакции

### Testnet

| ID | Тип транзакции | Пример транзакции V1
| ---: | --- | --- | --- |
...
| ID | Тип транзакции | Пример транзакции V2 |
| ---: | --- | --- | --- |
