...
Возвращает количество неподтвержденных странзакций в UTX pool.
...
Возвращает список статусов транзакций по ID транзакций. Список транзакций сохраняет порядок идентификаторов транзакций, которые были переданы в запросе. Если идентификаторы транзакций не были указаны, запрос не будет выполнен, и будет возвращена ошибка.
