...
> :warning: Данный метод доступен начиная с версии ноды 1.2.0, после активации №&nbsp;15 “Ride V4, VRF, Protobuf, Failed transactions”, см. [Протокол активации](/ru/waves-node/activation-protocol).
...
* Подписанный запрос на перевод:
    ...
    ```
    "assetId" [optional] - ID ассета к отправке, Base58. Параметр не указывается для переводов WAVES.
    "senderPublicKey" - Публичный ключ аккаунта отправителя, Base58.
