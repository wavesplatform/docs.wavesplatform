...
| 16 | dApp-to-dApp invocations, Ride V5 | <br>• Добавлена версия 5 Стандартной библиотеки Ride.<br>• Добавлена возможность вызова dApp из dApp.<br>• Добавлен тип данных `BigInt`<br>Полный список изменений см. в статье [Release Notes](/ru/keep-in-touch/release-notes#версия-1-3-jumeirah) | | Июнь 2021 |
