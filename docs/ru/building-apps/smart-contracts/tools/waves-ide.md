...
* <https://stagenet.waves-ide.com/> — среда с поддержкой новых функций [Стандартной библиотеки версии 4](/ru/ride/script/standard-library), которая добавлена в релизе 1.2 и сейчас доступна только на Stagenet.
