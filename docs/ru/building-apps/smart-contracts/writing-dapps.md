...
### 5.3. Регистрация в каталоге

Чтобы как можно больше пользователей узнали о вашем приложении, зарегистрируйте его на [DappRadar](https://dappradar.com) — крупнейшем портале с рейтингом децентрализованных приложений. 
