...
- в скрипте будет использоваться версия 5 библиотеки стандартных функций,
...
Минимальная комиссия за любую транзакцию, кроме транзакций вызова скрипта, увеличивается на 0,004 WAVES за каждый участвующий смарт-ассет. Например, минимальная комиссия за транзакцию перевода составляет 0,001 WAVES, а в случае перевода смарт-ассета — 0,005 WAVES.
