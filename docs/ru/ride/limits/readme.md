...
| «Бесплатный» лимит сложности: если до его превышения вызываемая функция завершилась ошибкой или выбрасыванием исключения, комиссия за транзакцию вызова скрипта не взимается | 1500 |
