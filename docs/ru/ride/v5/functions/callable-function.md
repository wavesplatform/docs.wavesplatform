...
* Количество `Issue`, `Reissue`, `Burn`, `SponsorFee`, `ScriptTransfer`, `Lease`, `LeaseCancel`, выполняемых вызываемой функцией, — не более 10.
* Количество платежей в пользу dApp, приложенных к вызову скрипта, — 10.
