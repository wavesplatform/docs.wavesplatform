...
| Действие | Версия 3 | Версия 4 | Версия 5 |
|---|---|---|---|
| Добавление и изменение записей в [хранилище данных аккаунта](/ru/blockchain/account/account-data-storage) | ✓ | ✓ | ✓ |
| Удаление записей в [хранилище данных аккаунта](/ru/blockchain/account/account-data-storage) | | ✓ | ✓ |
| Переводы токенов | ✓ | ✓ | ✓ |
| Выпуск, довыпуск, сжигание токенов | | ✓ | ✓ |
| Настройка [спонсирования](/ru/blockchain/waves-protocol/sponsored-fee) | | ✓ | ✓ |
| Лизинг, отмена лизинга | | | ✓ |

Стандартная библиотека версии 4 доступна c момента активации фичи №&nbsp;15 “Ride V4, VRF, Protobuf, Failed transactions”.

:warning: Стандартная библиотека версии 5 добавлена в версии ноды 1.3.0 и включается с активацией фичи №&nbsp;16 “Continuations”. Версии 1.3.x в настоящее время доступны только для [Stagenet](/ru/blockchain/blockchain-network/).
...
С момента активации фичи № 15 стала невозможной оплата комиссии за транзакцию вызова скрипта за счет средств, переведенных dApp-скриптом отправителю. Если баланс отправителя недостаточен для оплаты комиссии, dApp-скрипт не выполняется.
...
Результат выполнения вызываемой функции в Стандартной библиотеке версии 4 или 5 представляет собой список действий скрипта. Действия будут выполнены в порядке, в котором они перечислены в списке.
...
| [ScriptTransfer](/ru/ride/structures/script-actions/script-transfer) | Перевод токена |
| [Lease](/ru/ride/structures/script-actions/lease) (v5) | Лизинг |
| [LeaseCancel](/ru/ride/structures/script-actions/issue) (v5) | Отмена лизинга |
