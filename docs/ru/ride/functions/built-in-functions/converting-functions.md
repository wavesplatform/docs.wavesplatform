...
| :--- | :--- | :--- | :--- |
| 1 | [addressFromPublicKey(ByteVector): Address](#address-from-public-key) | Получает [адрес](/ru/blockchain/account/address), соответствующий открытому ключу аккаунта | 82 |
| 2 | [addressFromRecipient(Address&#124;Alias): Address](#address-from-recipient) | Получает [адрес](/ru/blockchain/account/address), соответствующий [псевдониму](/ru/blockchain/account/alias) | 100 |
...
| 10 | [toString(Address): String](#to-string-address) | Конвертирует массив байтов [адреса](/ru/blockchain/account/address) в строку | 10 |
...
#### `publicKey`: [ByteVector](/ru/ride/data-types/byte-vector)
...
#### `b`: [Boolean](/ru/ride/data-types/boolean)
...
#### `s`: [String](/ru/ride/data-types/string)
...
#### `bin`: [ByteVector](/ru/ride/data-types/byte-vector)
...
#### `offset`: [Int](/ru/ride/data-types/int)
...
#### `Address`: [Address](/ru/ride/structures/common-structures/address)
...
#### `u`: [ByteVector](/ru/ride/data-types/byte-vector)
