...
Функцию можно использовать для проверки достоверности цифровой подписи транзакции блокчейна Ethereum, сравнив полученный открытый ключ с ключом отправителя.
