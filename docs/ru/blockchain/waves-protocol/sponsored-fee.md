...
2. Спонсор получает сумму комиссии в спонсорском ассете.
...
Например, если спонсор установил соотношение 1 токен = 0,001 WAVES, то минимальная комиссия за транзакцию вызова скрипта составит 5 токенов, что соответствует 0,005 WAVES.

:warning: Обратите внимание:

* Пользователь может использовать спонсорский токен для оплаты транзакций, не связанных с использованием конкретного приложения.
...
Чтобы отключить спонсирование, нужно отправить транзакцию спонсирования, указав для `minSponsoredAssetFee` значение `null`.
...
* Использовать спонсорский ассет в 0Комиссию в спонсорском ассете можно платить только за транзакцию перевода и транзакцию вызова скрипта.
