...
кроме того, это позволяет платформе выдерживать высокую нагрузку, такую как распределение токенов, следующее за краудфандингом и эйрдропы бонусных токенов. Скорость обработки биржевых транзакций также повышается.
