...
**Матчер** — pасширение [ноды](#node), которое исполняет [ордера](#order) на бирже.
...
**Ордер** (или биржевая заявка) — инструкция клиенту на покупку или продажу [токена](#token) на бирже.
