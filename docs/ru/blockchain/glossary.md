...
**Байты тела транзакции** — байты всех полей [бинарного представления](/ru/blockchain/binary-format/transaction-binary-format/) транзакции, за исключением идентификатора и подтверждений (`proofs`) или, в зависимости от версии транзакции, идентификатора и подписи.

На основе байтов тела транзакции формируется идентификатор и подпись транзакции, см. раздел [Cryptographic Practical Details](/en/blockchain/waves-protocol/cryptographic-practical-details).
