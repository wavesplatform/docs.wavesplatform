...
Транзакция вызова скрипта и транзакция обмена сохраняются в блокчейне и отправитель платит комиссию при условии, они успешно прошли проверки 1–4. Если при этом проверки 5–6 не пройдены, транзакция сохраняется как невалидная и не приводит к изменениям в балансах (кроме взимания комиссии с отправителя) и в хранилищах данных аккаунтов. При этом в транзакции обмена комиссия матчера с ордеров не взимается.
