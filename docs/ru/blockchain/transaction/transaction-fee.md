...
* Вызов, к которому приложен платеж в смарт-ассете: 0,005 + `K` + 0,004 = 0,009 + `K` WAVES.
* Вызов, к которому приложено два платежа в смарт-ассетах: 0,005 + `K` + 2 × 0,004 = 0,013 + `K` WAVES.
* Вызов, который инициировал два перевода смарт-ассета и одно сжигание смарт-ассета: 0,005 + `K` + 3 × 0,004 = 0,017 + `K` WAVES.
* Вызов со смарт-аккаунта, к которому приложен платеж в смарт-ассетах и который инициировал два перевода и сжигание смарт-ассета: 0,005 + `K` + 0,004 + 4 × 0,004 = 0,025 + `K` WAVES (выполнен скрипт аккаунта и 4 раза — скрипт ассета).
