...
## Комиссия за невалидную транзакцию
...
Сохранение невалидных транзакций и взимание комиссии за них вводится в версии ноды 1.2.4, после активации фичи №&nbsp;17 “Accept transactions with failed script result”. На данный момент версии 1.2.x доступны на [stagenet](/ru/blockchain/blockchain-network/stage-network).
