...
Количество price-ассета, которое отправитель
...
Отметим, что в вычисленном значении количество знаков после запятой может превышать количество decimals у price-ассета. Например, результатом вычисления может быть число 0,123456789 WAVES. Ордер с таким ассетом будет отклонён матчером при постановке.
