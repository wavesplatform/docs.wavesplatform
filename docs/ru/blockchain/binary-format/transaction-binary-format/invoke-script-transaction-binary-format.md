...
| **7.6.1** | Количество аргументов функции |  | [Integer](/ru/blockchain/blockchain/blockchain-data-types) | 4 |  |
...
| **10.1** | Флаг типа токена комиссии | [Byte](/ru/blockchain/blockchain/blockchain-data-types) | 1 | 0 — WAVES<br>1 — другой токен |
