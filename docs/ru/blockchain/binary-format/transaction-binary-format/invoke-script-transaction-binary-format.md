...
| extra_fee_per_step | 1 байт | Надбавка, увеличивающая комиссию за каждый этап вычислений, см. раздел [Вычисления с продолжением](/ru/ride/advanced/continuation). Выражена в том же токене, что и комиссия |
