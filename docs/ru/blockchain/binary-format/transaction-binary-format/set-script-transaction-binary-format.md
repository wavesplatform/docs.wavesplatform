...
| **6.3** | Скрипт | script | Array[[Byte](/ru/blockchain/blockchain/blockchain-data-types)] | `S` | `S = 0`, если значение поля 6.1 равно 0.<br>`1 <= S <= 32767`, если значение поля 6.1 равно 1 |
