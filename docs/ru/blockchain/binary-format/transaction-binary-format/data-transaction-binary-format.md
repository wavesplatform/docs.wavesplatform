...
| **6.5** | Данные 1-го элемента | value | `T` | `S` | `T` — один из следующих: <br> - [Long](/ru/blockchain/blockchain/blockchain-data-types), `S = 8`<br> - [Boolean](/ru/blockchain/blockchain/blockchain-data-types), `S = 1` <br> - Array[[Byte](/ru/blockchain/blockchain/blockchain-data-types)], `S ⩽ 32767`<br>- [String](/ru/blockchain/blockchain/blockchain-data-types), `S ⩽ 32767` |
