...
| Поле | Описание |
| :--- | :--- |
| leaseId | Идентификатор транзакции лизинга |
| lease | Поля транзакции лизинга (не нужны при отправке транзакции, добавляются при получении транзакции через Node REST API) |
