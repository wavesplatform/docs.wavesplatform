...
где:
   ...
   `С` (complexity) — сложность вызываемой функции, `С`/4000 округляется вверх до ближайшего целого.
...
| extraFeePerStep | Надбавка, увеличивающая комиссию за каждый этап вычислений, см. раздел [Вычисления с продолжением](/ru/ride/advanced/continuation).Выражена в том же токене, что и комиссия. Поле добавлено в транзакции версии 3 |
