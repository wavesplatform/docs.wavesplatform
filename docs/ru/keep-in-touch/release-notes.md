...
* Добавлены встроенные функции:
   ...
   * [makeString](/ru/ride/functions/built-in-functions/string-functions#makestringlist-string-string) — объединяет строки из списка, используя разделитель. Сложность 30.
