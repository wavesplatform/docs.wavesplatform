...
* Добавлена версия 3 [транзакции вызова скрипта](/ru/blockchain/transaction-type/invoke-script-transaction), поддерживающая вложенные вызовы и до 10 приложенных платежей. Суммарная сложность всех вызываемых функций и скриптов ассетов в одной транзакции — не более 52&nbsp;000 (cложность скрипта аккаунта отправителя не учитывается в этом лимите).
