...
* Added the following built-in functions:
   ...
   * [ecrecover](/en/ride/functions/built-in-functions/verification-functions##ecrecover) — validates [ECDSA](https://en.wikipedia.org/wiki/ECDSA) digital signature. Complexity is ??.
