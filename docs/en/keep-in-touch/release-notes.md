...
* Added the following built-in functions:
   ...
   * [makeString](/en/ride/functions/built-in-functions/string-functions#makestringliststring-string-string) — concatenates list strings adding a separator. Complexity is 30.
