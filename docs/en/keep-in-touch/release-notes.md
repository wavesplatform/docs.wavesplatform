...
* Added the [groth16verify](/en/ride/functions/built-in-functions/verification-functions#groth16verify) built-in function for zero-knowledge proof verification. Its complexity equals 1900.
