...
All the assets issued on the Waves blockchain can be bought or sold on [Waves.Exchange](https://waves.exchange/) developed by the third-party team from the community (except [NFTs](/en/blockchain/token/non-fungible-token); smart assets trading is temporarily unavailable).
