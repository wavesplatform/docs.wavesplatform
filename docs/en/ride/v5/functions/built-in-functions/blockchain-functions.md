...
| [hashScriptAtAddress(Address&#124;Alias): ByteVector](#hashscriptataddress) | Returns [BLAKE2b-256](https://en.wikipedia.org/wiki/BLAKE_%28hash_function%29) hash of the script assigned to a given account. Fails if the account has no script | TBDL |
...
Returns [BLAKE2b-256](https://en.wikipedia.org/wiki/BLAKE_%28hash_function%29) hash of the script assigned to a given account. Fails if the account has no script.
