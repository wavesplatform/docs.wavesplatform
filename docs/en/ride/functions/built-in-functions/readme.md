...
A **built-in function** is a [function](/en/ride/functions.md) of the [script context](/en/ride/script/script-context.md).

## List of the built-in functions

### [Account data storage functions](/en/ride/functions/built-in-functions/account-data-storage-functions.md)
...
| 10 | wavesBalance(Address&#124;Alias): Int | Gets account balance in [WAVES](/en/blockchain/token/waves.md) | 109 |

### [Blockchain functions](/en/ride/functions/built-in-functions/blockchain-functions.md)

| # | Name | Description | Complexity |
| :--- | :--- | :--- | :--- |
| 1 | assetInfo(ByteVector): Аsset&#124;Unit | Gets the information about a [token](/en/blockchain/token.md) | 100 |
| 2 | blockInfoByHeight(Int): BlockInfo &#124;Unit | Gets the information about a [block](/en/blockchain/block.md) by the [block height](/en/blockchain/block/block-height.md) | 100 |
| 3 | transactionHeightById(ByteVector):  Int&#124;Unit | Gets the [block height](/en/blockchain/block/block-height.md) of a transaction | 100 |
| 4 | transferTransactionById(ByteVector): TransferTransaction&#124;Unit | Gets the data of a [transfer transaction](/en/blockchain/transaction-type/transfer-transaction.md) | 100 |

### [Byte array functions](/en/ride/functions/built-in-functions/byte-array-functions.md)
...
### [Converting functions](/en/ride/functions/built-in-functions/converting-functions.md)

| # | Name | Description | Complexity |
| :--- | :--- | :--- | :--- |
| 1 | addressFromPublicKey(ByteVector): Address | Converts account public key to [address](/en/blockchain/account/address.md) | 82 |
| 2 | addressFromRecipient(Address&#124;Alias): Address | Gets the corresponding [address](/en/blockchain/account/address.md) of the [alias](/en/blockchain/account/alias.md) | 100 |
...
| 10 | toString(Address): String | Converts an [address](/en/blockchain/account/address.md) to a string | 10 |
...
### [Data transaction functions](/en/ride/functions/built-in-functions/data-transaction-functions.md)
...
### [Decoding functions](/en/ride/functions/built-in-functions/decoding-functions.md)
...
### [Encoding functions](/en/ride/functions/built-in-functions/encoding-functions.md)
...
### [Exception functions](/en/ride/functions/built-in-functions/exception-functions.md)
...
### [Hashing functions](/en/ride/functions/built-in-functions/hashing-functions.md)
...
### [List functions](/en/ride/functions/built-in-functions/list-functions.md)
...
### [Math functions](/en/ride/functions/built-in-functions/math-functions.md)
...
### [String functions](/en/ride/functions/built-in-functions/string-functions.md)
...
### [Union functions](/en/ride/functions/built-in-functions/union-functions.md)
...
### [Verification functions](/en/ride/functions/built-in-functions/verification-functions.md)
