...
The **REST API section** is a section in the node configuration file with settings of a [node API](/en/waves-node/node-api.md).
...
See [Mining reward](/en/blockchain/mining/mining-reward.md) for more information.
