...
| 7 | Amount of asset B (amount asset), which the order sender offers for one price asset(asset A) | price | [Long](/en/blockchain/blockchain/blockchain-data-types) | 8 | |
| 8 | Amount of asset B (price asset), which the order sender wants to buy or send depending on order type | amount | Long | 8 | |
