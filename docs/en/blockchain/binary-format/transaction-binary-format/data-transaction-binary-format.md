...
| **6.5** | Value 1 | value | `T` | `S` | `T` is one of the following: <br> - [Long](/en/blockchain/blockchain/blockchain-data-types), `S = 8`<br> - [Boolean](/en/blockchain/blockchain/blockchain-data-types), `S = 1` <br> - Array[[Byte](/en/blockchain/blockchain/blockchain-data-types)], `S ⩽ 32767`<br>- [String](/en/blockchain/blockchain/blockchain-data-types), `S ⩽ 32767` |
