...
| **5.1** | Transferring token type flag | | [Byte](/en/blockchain/blockchain/blockchain-data-types) | 1 | Value is 0 for transferring [WAVES](/en/blockchain/token/waves).<br>Value is 1 for transferring other [token](/en/blockchain/token/) |
...
| **6.1** | Fee token type flag | | [Byte](/en/blockchain/blockchain/blockchain-data-types) | 1 | Value is 0 for fee in [WAVES](/en/blockchain/token/waves).<br>Value is 1 for fee in other [token](/en/blockchain/token/) |
