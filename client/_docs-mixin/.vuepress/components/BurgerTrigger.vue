<template>
    ...
    <div
        ...
        @click="toggle"
    >
        <span :class="$style.burger__element"></span>
        <span :class="$style.burger__element"></span>
        <span :class="$style.burger__element"></span>
    </div>
</template>
